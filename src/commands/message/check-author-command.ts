...
export class CheckAuthorMessageCommand implements Command {
    public names = [Lang.getRef('messageCommands.checkMsgAuthor', Language.Default)];
    ...
    public async execute(
        ...
        const { guild, targetMessage } = intr;
